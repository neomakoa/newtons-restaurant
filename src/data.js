import bg1 from "./assets/images/luca-bravo-8x_fFNrmeDk-unsplash.jpg";
import bg2 from "./assets/images/jason-leung-poI7DelFiVA-unsplash.jpg";
import bg3 from "./assets/images/ivan-stern-LOLSb7m6XkU-unsplash.jpg";
import bg4 from "./assets/images/nick-karvounis-Ciqxn7FE4vE-unsplash.jpg";
import bg5 from "./assets/images/patrick-tomasso-GXXYkSwndP4-unsplash.jpg";
import bg6 from "./assets/images/qui-nguyen-cnTdKzMOBns-unsplash.jpg";
    ...
    items: [
      ...
      },
      {
        ...
        platter: [
          ...
          { ingredient: "Rainbow Roll: Crab, avocado, and assorted sashimi on top." },
          { ingredient: "Volcano Roll: Baked scallops, spicy mayo, and avocado." },
        ],
      },
      {
